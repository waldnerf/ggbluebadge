...
#' @rdname theme_csiro
#' @export
theme_csiro_dark <- function(base_family = "sans", base_size = 12, base_color = "white", line_size = 0.2,
                            ...
                            title.family =  "sans", title.face = "bold", title.color = csiro_cols("midday blue"),

#' \code{theme_csiro_dark} is a dark version.
#' @rdname theme_csiro
#' @export
theme_csiro_dark <- function(base_family = "Calibri", base_size = 12, base_color = "white", line_size = 0.2,
                            ...
                            legend.box = FALSE,
                            grid = FALSE, grid.minor = grid, grid.x = grid, grid.y = grid, grid.minor.x = grid.minor, grid.minor.y = grid.minor, grid.color = "white",
                            ticks = TRUE, ticks.x = ticks, ticks.y = ticks,
                            title.family = "Calibri", title.face = "bold", title.color = csiro_cols("midday blue"),
                            subtitle.family = base_family, subtitle.face = "plain", subtitle.color = base_color,
                            ...
                            axis.text.family = base_family, axis.text.face = "plain", axis.text.color = "white",
  ...
  theme_csiro(
    ...
    background.color = csiro_cols("midnight blue"),

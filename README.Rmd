...
``` {r main, fig.height = 2, fig.width = 2}
ggbluebadge::show_my_palette("main")
```


``` {r greys, fig.height = 2, fig.width = 2}
ggbluebadge::show_my_palette("greys")
```

``` {r primary, fig.height = 2, fig.width = 2}
ggbluebadge::show_my_palette("primary")
```

``` {r secondary, fig.height = 2, fig.width = 2}
ggbluebadge::show_my_palette("secondary")
```

``` {r data61, fig.height = 2, fig.width = 2}

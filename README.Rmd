...
``` {r main, fig.height = 3, fig.width = 4}
ggbluebadge::show_my_palette("main")
```


``` {r greys, fig.height = 3, fig.width = 4}
ggbluebadge::show_my_palette("greys")
```

``` {r primary, fig.height = 3, fig.width = 4}
ggbluebadge::show_my_palette("primary")
```

``` {r secondary, fig.height = 3, fig.width = 4}
ggbluebadge::show_my_palette("secondary")
```

``` {r data61, fig.height = 3, fig.width = 4}

...
``` {r data61, fig.height = 3.5, fig.width = 3.5}
...
3. theme_data61() is a custom theme to fit the Data61 visual identity, 

4. theme_data61_dark() has a black background.

5. theme_pub() is sober theme for publications.
